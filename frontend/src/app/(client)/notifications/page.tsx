...
export default function NotificationsPage() {
  ...
  const deleteAll = async () => {
    try {
      ...
      // Si el endpoint no existe, eliminarlas una por una
      ...
      <div>
            ...
            >
              ...
              >
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={deleteAll}
                    className="flex-1 px-4 py-3 rounded-xl bg-red-600 text-white text-sm font-medium hover:bg-red-700 transition-colors"
                  >
                    Sí, eliminar todas
                  </button>
                </div>
        ...
        {loading ? (
          ...
          >
            ...
            <p className="text-sm text-[#86868B] mt-1">Aquí aparecerán tus actualizaciones de pedidos, tickets y más</p>
          </motion.div>
        ) : (
